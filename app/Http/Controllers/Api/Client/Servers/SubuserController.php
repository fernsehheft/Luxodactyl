...
use Luxodactyl\Services\Subusers\SubuserCreationService;
use Luxodactyl\Repositories\Wings\DaemonServerRepository;
use Luxodactyl\Transformers\Api\Client\SubuserTransformer;
...
use Luxodactyl\Http\Requests\Api\Client\Servers\Subusers\GetSubuserRequest;
use Luxodactyl\Http\Requests\Api\Client\Servers\Subusers\StoreSubuserRequest;
use Luxodactyl\Http\Requests\Api\Client\Servers\Subusers\DeleteSubuserRequest;
use Luxodactyl\Http\Requests\Api\Client\Servers\Subusers\UpdateSubuserRequest;
...
class SubuserController extends ClientApiController
{
     ...
     * @throws \Luxodactyl\Exceptions\Service\Subuser\ServerSubuserExistsException
     * @throws \Luxodactyl\Exceptions\Service\Subuser\UserIsServerOwnerException
     * @throws \Throwable
     */
    ...
    {
        /** @var \Luxodactyl\Models\Subuser $subuser */
        $subuser = $request->attributes->get('subuser');
