...
namespace Luxodactyl\Extensions\Spatie\Fractalistic;
...
use Luxodactyl\Extensions\League\Fractal\Serializers\LuxodactylSerializer;
...
class Fractal extends SpatieFractal
{
    ...
    public function createData(): Scope
    {
        ...
        if (is_null($this->serializer)) {
            $this->serializer = new LuxodactylSerializer();
        }
